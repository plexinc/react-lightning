import type { Dimensions, INodeProps, RendererMain, TextureMap } from '@lightningjs/renderer';
...
export interface TextureDef<textureType extends keyof TextureMap = keyof TextureMap> {
  type: textureType;
