...
export const LinearTransition: Class<ReanimatedLinearTransition> = createBuilderWrapper(
    ...
    return (values: ExitAnimationsValues & EntryAnimationsValues) => ({
      animations: {
        originX: withDelay(
          ...
          // oxlint-disable-next-line typescript/no-explicit-any -- Reanimated typings are wrong
        ) as any,
        originY: withDelay(
          delay,
